...
var Nexting = function(){
  ...
  $('#VoteResult').append('<br><div class="nextButton ui buttom aligned fluid inverted button">NEXT MOVIE</div>');
  $('#VoteResult2').append('<br><div class="nextButton ui buttom aligned fluid inverted button">NEXT MOVIE</div>');
  VoteButton();
}
  ...
  $.ajax({  
    ...
    data: jsonStr,
      ...
      success: function(data) {
        result = data;
        console.log(result);
        $('#VoteResult2').append('<div><h3>Result</h3><i class="huge thumbs green up icon"></i><h3>' + 
              result.upVote + '</h3><br><br>');
        $('#VoteResult').append('<div><h3>Result</h3><i class="huge thumbs red down icon"></i><h3>' + 
